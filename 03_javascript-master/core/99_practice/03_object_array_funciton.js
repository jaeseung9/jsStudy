...
function minOrMax(a, b, isMin) {
  return isMin ? Math.min(a, b) : Math.max(a, b);
}

console.log(`최소값 : ${minOrMax(10, 20, true)}`);
console.log(`최대값 : ${minOrMax(10, 20, false)}`);
...
let stringsAsc = [...strings].sort();
console.log(stringsAsc);

let stringsDesc = [...strings].sort().reverse();
