...
- Rest(나머지) Paramter: 여러 개의 값을 하나의 배열로 '모으기'
...
//console.log(Math.max(numbers)); // 배열을 통채로 넣으면 NaN

// ...numbers는 [10, 20, 30]을 10, 20, 30으로 펼쳐준다.
console.log(Math.max(...numbers));

// 2. 배열 리터널에서 사용하기 (배열 합치기/복사)
const arr1 = [1, 2, 3];
const arr2 = [4, 5, 6];
