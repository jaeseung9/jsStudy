package com.ohgireffers.section01.init;
...
public class Application {
    public static void main(String[] args) {
        ...
        // 객체배열도 선언과 동시에 리터널({})로 초기화 할 수 있다.
        Car[] carArray2 = {
                new Car("페라리", 300),
                new Car("람보르기니", 350),
                new Car("롤스로이스", 250)
        ...
        // 주의: 실제 car객체가 복사되는것이 아니고 car를 가리키는 '주소값'만 복사된다.
        ...
        System.out.println("가장 빠른 자동차는" + fastestCar.getModelName() + "이미 시속은" + fastestCar.getMaxSpeed() + "입니다.");
