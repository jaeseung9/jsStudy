package com.ohgireffers.section02.uses;
...
public class MemberService {
    ...
    public void showAllMembers() {
        // MemberRepository.findAllMembers() 모든객체정보
    ...
    public void searchMemberById() {
        ...
        // 2. MemberRepository에서 모든 회원 정보를 가져온다.
        ...
        // 반목문이 끝날 때까지 회원을 찾지 못했다면(isFound가 여전히 false라면!!)
        if (!isFound) {
